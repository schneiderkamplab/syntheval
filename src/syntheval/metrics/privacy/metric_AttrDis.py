...
|   -> Recall                              :   %.4f  %.4f   |""" % (
    ...
    def normalize_output(self) -> list:
        ...
        if self.results != {}:
            ...
            return [{'metric': 'att_discl_risk', 'dim': 'p', 
                     'val': self.results["Attr Dis macro F1"], 'err': self.results["Attr Dis macro F1 se"], 
                     'n_val': 1-self.results["Attr Dis macro F1"], 'n_err': self.results["Attr Dis macro F1 se"]}]
        else: pass
